...
<form>
  ...
  <div class="form-row">
    <div class="form-group col-md-10">
      ...
      <input type="nombre" class="form-control" id="idPaciente">
    </div>
  </div>
  <div class="form-group col-md-10">
  ...
  <div class="form-group">
    <label for="exampleFormControlFile1">Subir imagen diagnostica</label><br>
  ...
  <button type="button" class="btn btn-primary" @click="calcularProbabilidad()">   Enviar   </button>
  <h2 id="nombreCompleto"></h2>
  <h3>Resultados de malignidad del examen ingresado:</h3> <br>
...
export default {
  ...
  methods:{
    calcularProbabilidad(){
      ...
      let perimetroMedio = parseFloat(document.getElementById("perimetro").value);
      ...
      let examen = {"examen": [radioMedio, texturaMedia, areaMedia, suavidadMedia, perimetroMedio]};
      console.log(examen);
      this.axios.put(`/paciente/${this.datos.identificacion}`, examen)
      .catch((err) => console.log(err.response));
      this.axios.post(`/paciente/predict/${this.datos.identificacion}`)
      .then((result) => {

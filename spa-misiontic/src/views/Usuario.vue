<template>
  <div class="paciente">   
     <div class="datos">
      ...
      <button class="btn btn-primary" @click="cargarDatosUsuario()">Cargar datos de usuario</button>
      <button class="btn btn-primary" @click="crearPaciente()">Crear Usuario</button>
      <button class="btn btn-warning" @click="actualizarPaciente()">Modificar Usuario</button>
...
export default {
    ...
    methods:{
      cargarDatosUsuario(){
        ...
        */
        this.datos.identificacion = window.localStorage.getItem("id");
        this.axios.get(`/user/${this.datos.identificacion}`)
        .then((result) =>{
      ...
      actualizarPaciente(){
          ...
          let paciente = {nombres:document.getElementById("nombres").value, apellidos:document.getElementById("apellidos").value,identificacion:document.getElementById("idPaciente").value,email:document.getElementById("email").value};
          ...
          this.axios.put(`/user/${this.datos.identificacion}`, paciente)
          .then((result)=>{
      ...
      crearPaciente(){
          let paciente = {nombres:document.getElementById("nombres").value, apellidos:document.getElementById("apellidos").value,_id:document.getElementById("idPaciente").value,email:document.getElementById("email").value};
          this.axios.post("/user", paciente)
          .then((result) =>{
      ...
      eliminarPaciente(){
          this.datos.identificacion = document.getElementById("idPaciente").value;
          this.axios.delete(`/user/${this.datos.identificacion}`)
          .then((result) => {
            document.getElementById("nombres").innerHTML = result.data.nombres;
            document.getElementById("apellidos").innerHTML = result.data.apellidos;
            document.getElementById("idPaciente").innerHTML = result.data._id;
